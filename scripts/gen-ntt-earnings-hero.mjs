...
// 行1「NTT株 2026年5月決算を分析」= 17文字（スペース含む）
// font-size 50 → 推定幅 ~850px（余白 ~175px ✓）
const line1 = 'NTT株 2026年5月決算を分析';
const line1Size = 50;
const line1Y = 295;

// 行2「増配・売上・EPSから今後を読む」= 15文字
// font-size 44 → 推定幅 ~660px（余白 ~270px ✓）
const line2 = '増配・売上・EPSから今後を読む';
const line2Size = 44;
const line2Y = 390;

// フィーチャーバー
const features = ['EPS推移', '連続増配', 'キャッシュフロー'];
...
const filename = 'ntt-earnings-analysis-2026.png';
