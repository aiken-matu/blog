/**
 * ジャックス減配リスク記事ヒーロー画像
 * generate-all-images.mjs の buildSVG / P.orangeBrown をそのまま使用
 */
...
// ── generate-all-images.mjs と完全同一の buildSVG ────────────────────────────
...
// ── orangeBrown プリセット（generate-all-images.mjs と完全同一） ─────────────
const P_orangeBrown = {
  grad1: '#FFF7ED',
  grad2: '#FED7AA',
  bar: '#F97316',
...
const opts = {
  ...
  subtitle: '配当性向89.5%・減配シミュレーション',
  features: ['2026年3月期決算', '配当性向89.5%', '減配シミュレーション'],
};
